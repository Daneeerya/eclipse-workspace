...
public class CRUD {
	public static void create(int i) {
		if (i == 0) {
			...
			String ID = product_data.ask_ID("smartphpone");
			framework_oop_arrays.classes.date_object purchaseDate = product_data.ask_purchaseDate();
			framework_oop_arrays.classes.date_object deliveryDate = product_data.ask_deliveryDate(purchaseDate);
			framework_oop_arrays.classes.date_object returnDate = product_data.ask_returnDate(deliveryDate);
			framework_oop_arrays.classes.date_object iniPromoDate = product_data.ask_startDatePromo(purchaseDate);
			...
			String ID = product_data.ask_ID("accessory");
			framework_oop_arrays.classes.date_object purchaseDate = product_data.ask_purchaseDate();
			framework_oop_arrays.classes.date_object deliveryDate = product_data.ask_deliveryDate(purchaseDate);
			framework_oop_arrays.classes.date_object returnDate = product_data.ask_returnDate(deliveryDate);
			framework_oop_arrays.classes.date_object iniPromoDate = product_data.ask_startDatePromo(purchaseDate);
	...
	public static void read_one(product p) {
		...
		if (p instanceof laptop) {
			...
			case 2: // Price
				...
				break;
			case 3: // IDuct
				cad = "The ID of the laptop is " + (menu.L).getID();
				break;
			...
			case 2: // Price
				...
				break;
			case 3: // IDuct
				cad = "The ID of the smartphone is " + (menu.S).getID();
				break;
			case 4: // Purchase Date
			...
			case 2: // Price
				...
				break;
			case 3: // IDuct
				cad = "The ID of the accessory is " + (menu.A).getID();
				break;
			case 4: // Purchase Date
	...
	public static void update(product p) {
		...
		if (p instanceof laptop) {
			...
			case 2: // Price
				...
				break;
			case 3: // IDuct
				String newID = insert_data.insert_id("Enter a new ID for the laptop", "ID laptop");
				(menu.L).setID(newID);
			...
			case 2: // Price
				...
				break;
			case 3: // IDuct
				String newID = insert_data.insert_id("Enter a new ID for the smartphone", "ID smartphone");
				(menu.S).setID(newID);
				cad = "ID updated to " + newID;
				break;
			case 4: // Purchase Date
			...
			case 5: // Delivery Date
				framework_oop_arrays.classes.date_object datePurchase = product_data
						.ask_deliveryDate((menu.S).getpurchaseDate());
				(menu.S).setdeliveryDate(datePurchase);
				break;
			case 6: // Return Date
				framework_oop_arrays.classes.date_object deliveryDate = product_data
						.ask_returnDate((menu.S).getdeliveryDate());
