...
public class product_data {
	...
	public static module_oop.classes.date_object ask_purchaseDate() {
		return insert_data.insert_date("purchase", "Purchase date");
	}

//	Fecha de entrega debe ser 1 días después de compra
	public static module_oop.classes.date_object ask_deliveryDate(module_oop.classes.date_object purchaseDate) {
		int duration = 0;
		module_oop.classes.date_object deliveryDate = null;
		do {
...
//		Fecha de devolución debe ser 2 días después de entrega
	public static module_oop.classes.date_object ask_returnDate(module_oop.classes.date_object deliveryDate) {
		int duration = 0;
		module_oop.classes.date_object returnDate = null;
		do {
...
//		Fecha de devolución debe ser 3 días después de compra
	public static module_oop.classes.date_object ask_purchaseDateReturn(module_oop.classes.date_object purchaseDate) {
		int duration = 0;
...
//		La fecha de inicio de promo no tiene ninguna condición
	public static module_oop.classes.date_object ask_startDatePromo(module_oop.classes.date_object purchaseDate) {
...
//	La fecha de fin de promo debe ser antes de la de inicio de promo
	public static module_oop.classes.date_object ask_endDatePromo(module_oop.classes.date_object startDatePromo) {
		module_oop.classes.date_object endDatePromo = null;
		int duration = 0;
		do {
	...
	public static float obtener_Precio_total(module_oop.classes.date_object fecha_devolucio, float price) {
