	...
	public static int valida_int(String message, String tittle) {
		...
		do {
			try {
				...
				JOptionPane.showMessageDialog(null, "No has introducido un número entero", "Error",
	...
	public static float valida_float(String message, String tittle) {
		...
		do {
			try {
				...
				JOptionPane.showMessageDialog(null, "No has introducido un número float", "Error",
						JOptionPane.ERROR_MESSAGE);
				correcto = false;
			}
		} while (correcto == false);
...
//________Valida_String________
	...
	// ________Valida_String_Optional_______
	public static String valida_string_optional(String message, String tittle) {
		String s = "";
		boolean correcto = true;
