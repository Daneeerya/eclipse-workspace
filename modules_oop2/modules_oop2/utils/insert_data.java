...
public class insert_data {
	...
	public static date_object insert_date_optional(String message_typeOfDate, String duration, String type_of_date) {
		...
		date_object fecha = null;
		do {
			date = validators.valida_string_optional("Can you enter the " + message_typeOfDate + " date? Format: DD/MM/YYYY \n It has to be" + duration
							+ "days later than the date you just entered, but this is optional",type_of_date);
	...
	public static String insert_id(String message_ID, String title_ID) {
		...
		do {
			id = validators.valida_string("Can you enter the String ID  ? Format: 3 numbers - letter Ex: 123-A", "Date"); 
