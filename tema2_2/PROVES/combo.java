...
public class combo {
	public static void main(String[] args) {
		int n = 0; int cont_a = 0; int cont_e = 0; int cont_i = 0; int cont_o = 0; int cont_u = 0;
		String s = "";
		...
		for(int i=0; i<n; i++) {
			seleccion1 = JOptionPane.showInputDialog(
					   ...
					   new Object[] { "letra_a", "letra_e", "letra_i", "letra_o", "letra_u" },
					   "letra_a");
		...
		JOptionPane.showMessageDialog(null, "La vocal a se ha contado: " + cont_a + " veces \n" +
											"La vocal e se ha contado: " + cont_e + " veces \n" +
											"La vocal i se ha contado: " + cont_i + " veces \n" +
											"La vocal o se ha contado: " + cont_o + " veces \n" +
											"La vocal u se ha contado: " + cont_u + " veces \n");
	}//end_main
}