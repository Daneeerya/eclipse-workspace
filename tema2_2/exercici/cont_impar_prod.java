...
public class cont_impar_prod {
	...
	public static void main(String[] args) {
		...
		while (cont < 3) {
			do {
				try {
					intro_num = JOptionPane.showInputDialog(null, "Escribe un num1 int", "Num int",
		...
		JOptionPane.showMessageDialog(null, "El prod dels 3 primers num impars es " + prod, "Resultado",
				JOptionPane.INFORMATION_MESSAGE);
	}// end-main
}// end-class
