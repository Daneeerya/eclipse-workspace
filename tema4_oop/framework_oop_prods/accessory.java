...
//	Constructor
	public accessory(int stock, float weight, float price, float price_total, String iD_prod,
			...
			float price_last_units, float price_sales, String type_of_product, boolean isPromo) {
