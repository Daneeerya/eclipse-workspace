...
import framework_oop_prods_sincad.regex;
	...
	public static product update (product p) {
		if (p instanceof laptop) {
			...
			case 6: //Creation date
			    ...
			    if (regex.r_fecha (newCreationDate)) {
					...
					JOptionPane.showMessageDialog(null, "No has introducido bien la fecha", "Result", JOptionPane.INFORMATION_MESSAGE);
			    }
