	...
	public static int valida_int(String message, String tittle) {
		...
		do {
			try {
				...
				if (num_input == null) {
					JOptionPane.showMessageDialog(null, "Exiting the application", "Coming out",
	...
	public static float valida_float(String message, String tittle) {
		...
		do {
			try {
				...
				JOptionPane.showMessageDialog(null, "You have not entered a float number", "Error",
						JOptionPane.ERROR_MESSAGE);
				correcto = false;
			}
		} while (correcto == false);
	...
	public static String valida_string(String message, String tittle) {
		...
		do {
			try {
				...
				JOptionPane.showMessageDialog(null, "You have not entered a string", "Error",
						JOptionPane.ERROR_MESSAGE);
				correcto = false;
			}
		} while (correcto == false);
